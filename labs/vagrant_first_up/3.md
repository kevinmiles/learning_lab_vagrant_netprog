...
1. ***Note: Due to the nature of the Nexus 9000v shell, vagrant will report an error after starting the VM.  This is expected, and does not indicate a problem.  Simple enter `vagrant up` again to complete the setup successfully.***
